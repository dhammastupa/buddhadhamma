...
<button class="bg-green-300 font-bold hover:text-blue-600 py-2 px-4 mb-4 rounded items-center content-center flex" name="button" onclick="http://www.google.com">
    Click me
</button>
